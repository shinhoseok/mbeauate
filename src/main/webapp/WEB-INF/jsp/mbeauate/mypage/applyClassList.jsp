...
<body>
	...
	<section class="my_menu2">
		<!-- 타이틀 -->
		<div class="page-tit">
			<h2 class="myclass_tit">내 정보 수정</h2>
			<div>
				<a class="btn_r2" href="javascript:void(0);" onclick="javascript:fn_mypageAllCheck();">전체선택</a>
				<a class="btn_r2" href="javascript:void(0);" onclick="javascript:fn_mypageChkDel();">선택삭제</a>
			</div>
		</div>
		<!-- //타이틀 -->
		<!-- 수업리스트-->
		<div class="myclass_list" id="target"></div>
		<!-- //수업리스트---->
	</section>
...
var fn_allSearchList = function() {
	...
	$.ajax({	
		url: "${basePath}/mypage/r/t/selectMyClassAjaxList.do",
		type: 'POST',
		dataType: 'html',
		data: params,
		success: function(r) {
