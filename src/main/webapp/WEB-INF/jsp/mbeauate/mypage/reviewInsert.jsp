...
<body>
	...
	<section class="my_menu2">
		...
		<div class="review_list">
			...
			<div class="write">
				<p class="font_60">
					<textarea style="width: 100%" id="reviewCttTextArea" name="reviewCttTextArea" rows="5" onfocus="checker(this, 200 , 'nbytes_reviewCtt');" onblur="stopchecker();" placeholder="멘티님께 어떤 도움이 되었나요?"></textarea>
				</p>
